const PRODUCTS = {
  home: [
    ...
    {
      id: 103,
      name: "Haori Branco Chamas Vermelhas",
      price: 469.9,
      oldPrice: 580.0,
      category: "Capas",
      tag: "LIMITADO",
      description:
        "Haori branco de alta qualidade com chamas vermelhas bordadas na borda inferior, fiel ao estilo de Jiraiya em batalha. Tecido de algodão japonês premium. O kanji 仙 bordado na costas. Edição limitada.",
      svg: "cape_white",
      sizes: ["P", "M", "G", "GG"],
      page: "home",
    },
    {
      id: 104,
      name: "Livro Ilustrado: A Saga do Sennin",
      price: 99.9,
      oldPrice: 129.9,
      category: "Livros",
      tag: "NOVO",
      description:
        "Livro de arte oficial com ilustrações exclusivas de Jiraiya e do Monte Myoboku. 180 páginas em papel couchê, capa dura vermelha com detalhes dourados. Edição especial com marcador artesanal.",
      svg: "senin_book",
      sizes: ["U"],
      page: "home",
    },
  ...
  gamabunta: [
    ...
    {
      id: 71,
      name: "Tanto do Chefe dos Sapos",
      price: 319.9,
      oldPrice: 400.0,
      category: "Colecionáveis",
      tag: "LIMITADO",
      description:
        "Réplica do tanto de Gamabunta em resina com acabamento envelhecido. Detalhes em bronze e couro vermelho no cabo. 55cm. Suporte de parede incluso. Edição numerada de 200 unidades.",
    ...
    {
      id: 72,
      name: "Jaqueta Couro Escarlate",
      price: 589.9,
      oldPrice: 720.0,
      category: "Vestimentas",
      tag: "NOVO",
      description:
        "Jaqueta de couro sintético escarlate inspirada na pele de Gamabunta. Botões de bronze envelhecido, gola alta, forração interna. Símbolo do clã bordado na manga esquerda.",
      svg: "vest_red",
      sizes: ["P", "M", "G", "GG"],
      page: "gamabunta",
    },
    {
      id: 73,
      name: "Colar Bronze do Chefe",
      price: 189.9,
      oldPrice: null,
      category: "Joias",
      tag: null,
      description:
        "Colar robusto em corrente de bronze envelhecido com pingente de garra de sapo. Comprimento 65cm ajustável. Forjado à mão, inspirado no visual imponente de Gamabunta.",
      svg: "toad_necklace",
      sizes: ["U"],
      page: "gamabunta",
    },
    {
      id: 74,
      name: "Conjunto Chefe dos Sapos",
      price: 879.9,
      oldPrice: 1100.0,
      category: "Conjuntos",
      tag: "OFERTA",
      description:
        "Conjunto completo Gamabunta: kimono escarlate, haori vermelho daimyo, colar bronze do chefe e caneca sake. Embalagem em caixa madeira com lacre de cera. O visual completo do Chefe dos Sapos.",
      svg: "kimono_red",
      sizes: ["P", "M", "G", "GG"],
      page: "gamabunta",
    },
  ...
  fukasaku: [
    ...
    {
      id: 41,
      name: "Cajado do Ancião Verde",
      price: 249.9,
      oldPrice: 310.0,
      category: "Colecionáveis",
      tag: "RARO",
      description:
        "Réplica do cajado de Fukasaku em madeira balsa envernizada com detalhes em cobre verde-patina. 85cm de comprimento. Kanji de sabedoria gravado no topo. Suporte de exibição incluso.",
      svg: "scroll_summoning",
      sizes: ["U"],
      page: "fukasaku",
    },
    {
      id: 42,
      name: "Kimono Verde Floresta Sagrada",
      price: 379.9,
      oldPrice: 470.0,
      category: "Kimonos",
      tag: "DESTAQUE",
      description:
        "Kimono em tecido de algodão japonês cor verde floresta profunda, inspirado em Fukasaku. Bordados de folhas de bambu e o kanji da sabedoria ao longo das mangas. Inclui obi verde dourado.",
      svg: "red_haori",
      sizes: ["P", "M", "G", "GG"],
      page: "fukasaku",
    },
    {
      id: 43,
      name: "Chá das Florestas de Myoboku",
      price: 79.9,
      oldPrice: null,
      category: "Bem-estar",
      tag: "MAIS VENDIDO",
      description:
        "Blend de chás naturais inspirado nas ervas do Monte Myoboku. Combinação de bambu, folha de lótus, hortelã e gengibre. 50g em sachês artesanais. Embalagem em caixinha de bambu.",
      svg: "oil_sage_potion",
      sizes: ["U"],
      page: "fukasaku",
    },
    {
      id: 44,
      name: "Pergaminho do Modo Sábio",
      price: 139.9,
      oldPrice: 170.0,
      category: "Colecionáveis",
      tag: null,
      description:
        "Réplica decorativa do pergaminho de ensinamentos do Modo Sábio de Fukasaku. Caligrafia japonesa em nanquim verde sobre papel de arroz envelhecido. Enrolado com cordão dourado.",
      svg: "scroll_summoning",
      sizes: ["U"],
      page: "fukasaku",
    },
    {
      id: 45,
      name: "Conjunto Sábio Ancião Completo",
      price: 649.9,
      oldPrice: 830.0,
      category: "Conjuntos",
      tag: "OFERTA",
      description:
        "Conjunto completo Fukasaku: kimono verde floresta, colar dos sapos sábios, cajado do ancião e kit meditação Myoboku. Embalagem em caixa madeira com kanji de sabedoria. Tamanho sob consulta.",
      svg: "kimono_red",
      sizes: ["P", "M", "G", "GG"],
      page: "fukasaku",
    },
  ...
  shima: [
    ...
    {
      id: 51,
      name: "Kimono Roxo Ancestral",
      price: 389.9,
      oldPrice: 490.0,
      category: "Kimonos",
      tag: "LIMITADO",
      description:
        "Kimono em tecido de seda japonesa na cor roxo profundo de Shima. Bordados de nenúfares e kanji sagrados de Myoboku ao longo das mangas. Fechamento com obi dourado incluso.",
      svg: "red_haori",
      sizes: ["P", "M", "G", "GG"],
      page: "shima",
    },
    {
      id: 52,
      name: "Estatueta Shima Anciã",
      price: 279.9,
      oldPrice: 340.0,
      category: "Colecionáveis",
      tag: "RARO",
      description:
        "Estatueta de resina pintada à mão da Grande Sapo Shima em postura de meditação. 14cm de altura, base em bambu lacado. Detalhes em lilás e roxo profundo com expressão serena.",
      svg: "toad_figurine_fukasaku",
      sizes: ["U"],
      page: "shima",
    },
    {
      id: 53,
      name: "Vela Aromática Monte Myoboku",
      price: 89.9,
      oldPrice: null,
      category: "Casa",
      tag: null,
      description:
        "Vela artesanal em cera de soja com fragrância de bambu, musgo e sândalo. Pote em vidro roxo ametista com lacre em cera. Tempo de queima 45h. Inspirada na paz do Monte Myoboku.",
      svg: "oil_sage_potion",
      sizes: ["U"],
      page: "shima",
    },
    {
      id: 54,
      name: "Lenço de Seda Ancestral",
      price: 119.9,
      oldPrice: 150.0,
      category: "Acessórios",
      tag: "MAIS VENDIDO",
      description:
        "Lenço de seda fina 100% natural em roxo violeta com bordas em dourado. Estampa dos nenúfares do Monte Myoboku. 70x70cm. Pode ser usado no cabelo, pescoço ou bolso.",
      svg: "white_hair_wig",
      sizes: ["U"],
      page: "shima",
    },
    {
      id: 55,
      name: "Anel do Clã dos Sapos",
      price: 149.9,
      oldPrice: null,
      category: "Joias",
      tag: "NOVO",
      description:
        "Anel em liga de prata com pedra ametista central, inspirado em Shima. Gravação interna: clã dos sapos sábios. Disponível em tamanhos 12 a 22. Acabamento envelhecido artesanal.",
      svg: "toad_necklace",
    ...
    {
      id: 56,
      name: "Conjunto Meditação Shima",
      price: 299.9,
      oldPrice: 380.0,
      category: "Conjuntos",
      tag: "OFERTA",
      description:
        "Conjunto completo de meditação inspirado em Shima: tapete roxo com bordas douradas, kit incenso sagrado, pedra ametista natural e vela aromática Monte Myoboku. Embalagem presente inclusa.",
      svg: "oil_sage_potion",
      sizes: ["U"],
      page: "shima",
    },
  ...
  gamahiro: [
    ...
    {
      id: 61,
      name: "Kimono Azul Espadachim",
      price: 420.0,
      oldPrice: 540.0,
      category: "Kimonos",
      tag: "DESTAQUE",
      description:
        "Kimono de combate inspirado em Gamahiro, em tecido azul celeste resistente com painéis prateados. Movimento livre para golpes, kanji de velocidade bordado na costas. Inclui faixa prata.",
      svg: "red_haori",
      sizes: ["P", "M", "G", "GG"],
      page: "gamahiro",
    },
    {
      id: 62,
      name: "Bracelete Prata Celeste",
      price: 179.9,
      oldPrice: null,
      category: "Joias",
      tag: "NOVO",
      description:
        "Bracelete artesanal em metal prateado com pedra lazúli azul celeste. Gravação do kanji de velocidade e do símbolo do clã dos sapos. Ajustável. Inspirado nas escamas de Gamahiro.",
      svg: "toad_necklace",
      sizes: ["U"],
      page: "gamahiro",
    },
    {
      id: 63,
      name: "Capa Tática Azul Nível S",
      price: 359.9,
      oldPrice: 440.0,
      category: "Capas",
      tag: "LIMITADO",
      description:
        "Capa curta de combate em tecido técnico azul cobalto, inspirada no estilo de Gamahiro. Bolsos internos para pergaminhos de invocação, capuz reforçado, costuras duplas militares.",
      svg: "cape_white",
      sizes: ["P", "M", "G", "GG"],
      page: "gamahiro",
    },
    {
      id: 64,
      name: "Conjunto Espadachim Completo",
      price: 799.9,
      oldPrice: 1050.0,
      category: "Conjuntos",
      tag: "OFERTA",
      description:
        "Conjunto completo Gamahiro: kimono azul celeste, capa tática, máscara do guerreiro e bracelete prata. Embalagem em caixa temática com certificado de autenticidade. Tamanho sob consulta.",
      svg: "kimono_red",
      sizes: ["P", "M", "G", "GG"],
      page: "gamahiro",
    },
  ...
  gamaken: [
    ...
    {
      id: 81,
      name: "Escudo Carmesim de Batalha",
      price: 269.9,
      oldPrice: 340.0,
      category: "Colecionáveis",
      tag: "RARO",
      description:
        "Réplica decorativa do escudo de batalha de Gamaken em resina pintada à mão. Carmesim profundo com bordas douradas e o símbolo do clã dos sapos em relevo. 35cm de diâmetro. Suporte incluso.",
      svg: "scroll_summoning",
      sizes: ["U"],
      page: "gamaken",
    },
    {
      id: 82,
      name: "Kimono Carmesim Guerreiro",
      price: 449.9,
      oldPrice: 560.0,
      category: "Kimonos",
      tag: "NOVO",
      description:
        "Kimono de batalha em tecido reforçado cor carmesim profundo, inspirado em Gamaken. Ombros estruturados, manga curta para liberdade de movimento. Kanji de força bordado nas costas.",
      svg: "red_haori",
      sizes: ["P", "M", "G", "GG"],
      page: "gamaken",
    },
    {
      id: 83,
      name: "Conjunto Guerreiro Completo",
      price: 849.9,
      oldPrice: 1050.0,
      category: "Conjuntos",
      tag: "OFERTA",
      description:
        "Conjunto completo Gamaken: kimono carmesim, máscara Modo Sábio, escudo carmesim de batalha e pergaminho de invocação. Embalagem premium em caixa temática. O visual do guerreiro dos sapos.",
      svg: "kimono_red",
      sizes: ["P", "M", "G", "GG"],
      page: "gamaken",
    },
  ...
  gamamaru: [
    ...
    {
      id: 91,
      name: "Kimono Dourado do Profeta",
      price: 519.9,
      oldPrice: 650.0,
      category: "Kimonos",
      tag: "DESTAQUE",
      description:
        "Kimono longo em seda dourada envelhecida, inspirado em Gamamaru. Bordados de kanji proféticos em fio de ouro. Representa a sabedoria eterna do profeta maior do Monte Myoboku. Inclui cinto bronzeado.",
      svg: "red_haori",
      sizes: ["P", "M", "G", "GG"],
      page: "gamamaru",
    },
    {
      id: 92,
      name: "Incensário das Profecias",
      price: 159.9,
      oldPrice: null,
      category: "Casa",
      tag: "NOVO",
      description:
        "Incensário de cerâmica pintada à mão com padrões dourados e kanji das profecias de Gamamaru. Inclui 30 varetas de incenso artesanal de sândalo e bambu. Peça única de decoração e bem-estar.",
      svg: "oil_sage_potion",
      sizes: ["U"],
      page: "gamamaru",
    },
    {
      id: 93,
      name: "Conjunto Profeta Ancestral",
      price: 929.9,
      oldPrice: 1180.0,
      category: "Conjuntos",
      tag: "OFERTA",
      description:
        "Conjunto completo Gamamaru: manto do grande profeta, kimono dourado, chapéu do sábio milenar e colar da profecia. A representação completa do maior ancião de Myoboku. Numerado e certificado.",
      svg: "kimono_red",
      sizes: ["P", "M", "G", "GG"],
      page: "gamamaru",
    },
  ...
  naruto: [
    ...
    {
      id: 101,
      name: "Jaqueta Modo Sábio Naruto",
      price: 429.9,
      oldPrice: 530.0,
      category: "Vestimentas",
      tag: "NOVO",
      description:
        "Jaqueta laranja inspirada no visual de Naruto no Modo Sábio. Detalhe dos olhos de sapo bordados no capuz, kanji do Monte Myoboku na costas. Tecido técnico resistente, forro térmico.",
      svg: "vest_red",
      sizes: ["P", "M", "G", "GG"],
      page: "naruto",
    },
    {
      id: 102,
      name: "Poster Naruto Modo Sábio",
      price: 59.9,
      oldPrice: null,
      category: "Casa",
      tag: "MAIS VENDIDO",
      description:
        "Poster artístico de alta qualidade de Naruto em Modo Sábio. Impressão em papel fotográfico 300g, 60x90cm. Arte exclusiva estilo ukiyo-e japonês. Tube de transporte incluso. Moldura opcional.",
      svg: "toad_figurine_gamabunta",
      sizes: ["U"],
      page: "naruto",
    },
